      ...
      <main className="flex-grow container mx-auto p-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-muted/50 border-2 border-dashed border-border rounded-lg aspect-video flex items-center justify-center overflow-hidden">
             <img src={imageUrl1} alt="Stereogram of a CD with pink stars" className="object-cover w-full h-full" data-ai-hint="cd stars" />
          </div>
          <div className="bg-muted/50 border-2 border-dashed border-border rounded-lg aspect-video flex items-center justify-center overflow-hidden">
             <img src={imageUrl2} alt="Stereogram of an astronaut in space" className="object-cover w-full h-full" data-ai-hint="astronaut space" />
          </div>
          <div className="bg-muted/50 border-2 border-dashed border-border rounded-lg aspect-video flex items-center justify-center overflow-hidden">
             <img src={imageUrl2} alt="Stereogram of an astronaut in space" className="object-cover w-full h-full" data-ai-hint="astronaut space" />
          </div>
