...
export const exerciseData: Unit[] = [
  ...
  },
  {
    ...
    videos: [
        ...
        { id: 'vid-2-4', level: 14, title: 'Module 2(d)inosaur', description: 'Working with binaural beats tuned to pineal gland frequencies.', thumbnailUrl: 'https://placehold.co/800x450', videoUrl: 'https://firebasestorage.googleapis.com/v0b/pinealvision.firebasestorage.app/o/7B79617E-B7F3-4BA8-A666-2107F6AEE307.mov?alt=media' },
  ...
  },
  {
    ...
    videos: [
        { id: 'vid-3-1', level: 21, title: 'Module 3(a)spen', description: 'An immersive journey through stars and galaxies to expand your sense of self.', thumbnailUrl: 'https://placehold.co/800x450', videoUrl: 'https://firebasestorage.googleapis.com/v0/b/pinealvision.firebasestorage.app/o/Video.mp4?alt=media' },
