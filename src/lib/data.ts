...
export const exerciseData: Unit[] = [
  ...
  },
  {
    ...
    videos: [
        { id: 'vid-3-1', level: 21, title: 'Module 3(a)spen', description: 'An immersive journey through stars and galaxies to expand your sense of self.', thumbnailUrl: 'https://placehold.co/800x450', videoUrl: 'https://firebasestorage.googleapis.com/v0/b/pinealvision.firebasestorage.app/o/Video%206.MP4?alt=media' },
        { id: 'vid-3-2', level: 22, title: 'Module 3(b)eech', description: 'Use abstract visual cues to help you listen to your inner voice.', thumbnailUrl: 'https://placehold.co/800x450', videoUrl: 'https://firebasestorage.googleapis.com/v0/b/pinealvision.firebasestorage.app/o/Video%2015.MP4?alt=media' },
        { id: 'vid-3-3', level: 23, title: 'Module 3(c)atalpa', description: 'A free-form visual meditation to unlock your inner vision.', thumbnailUrl: 'https://placehold.co/800x450', videoUrl: 'https://firebasestorage.googleapis.com/v0/b/pinealvision.firebasestorage.app/o/Video.mp4?alt=media' },
        { id: 'vid-3-4', level: 24, title: 'Module 3(d)ogwood', description: 'Meditation on the concept of universal consciousness.', thumbnailUrl: 'https://placehold.co/800x450', videoUrl: 'https://firebasestorage.googleapis.com/v0/b/pinealvision.firebasestorage.app/o/Video%208.MP4?alt=media' },
        { id: 'vid-3-5', level: 25, title: 'Module 3(e)ucalyptus', description: 'Remote viewing basics: sensing a location from a distance.', thumbnailUrl: 'https://placehold.co/800x450', videoUrl: 'https://firebasestorage.googleapis.com/v0/b/pinealvision.firebasestorage.app/o/Video%207.MP4?alt=media' },
        { id: 'vid-3-6', level: 26, title: 'Module 3(f)ir', description: 'Exploring the Akashic records through guided meditation.', thumbnailUrl: 'https://placehold.co/800x450', videoUrl: 'https://firebasestorage.googleapis.com/v0/b/pinealvision.firebasestorage.app/o/Video%205.MP4?alt=media' },
        { id: 'vid-3-7', level: 27, title: 'Module 3(g)inkgo', description: 'Connecting with spirit guides or your higher self.', thumbnailUrl: 'https://placehold.co/800x450', videoUrl: 'https://firebasestorage.googleapis.com/v0/b/pinealvision.firebasestorage.app/o/Video%2014.MP4?alt=media' },
        { id: 'vid-3-8', level: 28, title: 'Module 3(h)azelnut', description: 'Perceiving past lives and their influence.', thumbnailUrl: 'https://placehold.co/800x450', videoUrl: 'https://firebasestorage.googleapis.com/v0/b/pinealvision.firebasestorage.app/o/Video%2013.MP4?alt=media' },
        { id: 'vid-3-9', level: 29, title: 'Module 3(i)lex', description: 'Astral projection preparation and techniques.', thumbnailUrl: 'https://placehold.co/800x450', videoUrl: 'https://firebasestorage.googleapis.com/v0/b/pinealvision.firebasestorage.app/o/Video%2017.MP4?alt=media&token=05e8ad7c-3a15-42c7-9c79-95dc5c452cef' },
        { id: 'vid-3-10', level: 30, title: 'Module 3(j)acaranda', description: 'Merging your consciousness with an object or plant.', thumbnailUrl: 'https://placehold.co/800x450', videoUrl: 'https://firebasestorage.googleapis.com/v0/b/pinealvision.firebasestorage.app/o/Video%2011.MP4?alt=media' },
    ],
  },
];
