...
export const exerciseData: Unit[] = [
  ...
  },
  {
    ...
    videos: [
        ...
        { id: 'vid-3-9', level: 29, title: 'Module 3(i)lex', description: 'Astral projection preparation and techniques.', thumbnailUrl: 'https://placehold.co/800x450', videoUrl: 'https://firebasestorage.googleapis.com/v0/b/pinealvision.firebasestorage.app/o/Video%2012.MP4?alt=media' },
